...
# (8) 7.3 Частые сценарии

# Сумма чисел
#
# На вход программе подается натуральное число n. Напишите программу,
# которая подсчитывает сумму тех чисел от 1 до n (включительно) квадрат
# которых оканчивается на 2, 5 или 8.
#
# Формат входных данных
